...
marketplace = {
  ...
  "name" => "agency-skills",
  "description" => "Agency, marketing, product, scientific, and engineering specialist skills for Claude Code.",
  "owner" => {
    "name" => "bestagentkits"
  },
  "plugins" => [
    {
      ...
      "keywords" => ["skills", "agents", "agency", "marketing", "product", "science", "specialists"],
      "source" => {
        "source" => "github",
