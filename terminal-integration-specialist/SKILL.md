...
description: "Use when Codex should act as the Terminal Integration Specialist specialist from Agency Agents. Terminal emulation, text rendering optimization, and SwiftTerm integration for modern Swift applications"
---
