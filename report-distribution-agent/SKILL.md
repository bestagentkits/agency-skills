...
description: "Use when Codex should act as the Report Distribution Agent specialist from Agency Agents. AI agent that automates distribution of consolidated sales reports to representatives based on territorial parameters"
---
