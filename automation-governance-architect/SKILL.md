...
description: "Use when Codex should act as the Automation Governance Architect specialist from Agency Agents. Governance-first architect for business automations (n8n-first) who audits value, risk, and maintainability before implementation."
---
