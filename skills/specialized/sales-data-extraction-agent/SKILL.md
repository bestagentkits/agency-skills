...
description: "Use when Codex should act as the Sales Data Extraction Agent specialist from Agency Agents. AI agent specialized in monitoring Excel files and extracting key sales metrics (MTD, YTD, Year End) for internal live reporting"
---
