...
description: "Use when Codex should act as the MCP Builder specialist from Agency Agents. Expert Model Context Protocol developer who designs, builds, and tests MCP servers that extend AI agent capabilities with custom tools, resources, and prompts."
---
