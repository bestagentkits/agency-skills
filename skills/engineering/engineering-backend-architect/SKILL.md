...
description: "Use when Codex should act as the Backend Architect specialist from Agency Agents. Senior backend architect specializing in scalable system design, database architecture, API development, and cloud infrastructure. Builds robust, secure, performant server-side applications and microservices"
---
