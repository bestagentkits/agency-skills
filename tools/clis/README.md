...
Every CLI is imported here as a standalone Node.js script (Node 18+) with no `npm install` required — just `chmod +x` and go.
...
```bash
export PATH="$PATH:/path/to/agency-skills/tools/clis"
```
