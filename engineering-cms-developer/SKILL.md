...
description: "Use when Codex should act as the CMS Developer specialist from Agency Agents. Drupal and WordPress specialist for theme development, custom plugins/modules, content architecture, and code-first CMS implementation"
---
